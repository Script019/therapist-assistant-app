    ...
    <div className="p-6 max-w-5xl mx-auto space-y-6">
      ...
      <ul className="space-y-4">
        {mockClients.map((client) => (
          <li
            key={client.id}
            className="bg-white rounded-xl shadow-md p-5 flex flex-col sm:flex-row justify-between sm:items-center"
          >
            <div>
            ...
            <Link
              ...
              className="mt-3 sm:mt-0 text-sm text-blue-600 underline font-medium"
            >
              View Profile
            </Link>
          </li>
